...
- Я только начинаю свой путь в области ML/DS, поэтому в портфолио много учебных проектов
  - Алгоритм [быстрой лемматизации](https://github.com/Gomemnon/Fast-Lemmatization). Основаная идея изложена в статье по ссылке из readme. Код доработан так, что можно лемматизировать 1.6 млн. твитов за 2 минуты
- Для рабочих задач написал свою [мини библиотеку](https://github.com/Gomemnon/pre_processing_dissertation_data) для автоматизации процесса обработки и подготовки данных
