...
- Я только начинаю свой путь в области ML/DS, поэтому в портфолио много учебных проектов
  - Алгоритм [быстрой лемматизации](https://github.com/Gomemnon/Fast-Lemmatization). Основаная идея изложена в статье по ссылке из readme. Код доработан так, что можно лемматизировать 1600000 твитов за 2 минуты
